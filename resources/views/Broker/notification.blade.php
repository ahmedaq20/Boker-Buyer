                ...
                margin-top: 1px;">
                    <div class="about-info1">
                       <p class="prag4" style="padding-left: 20px; font-size: 25px">
                        You are loging to site success since 1 minutes
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-12 d-flex flex-column">
                ...
                margin-top: 1px;">
                    <div class="about-info1">
                       <p class="prag4" style="padding-left: 20px; font-size: 25px">
                        You are loging to site success since 2 hours
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-12 d-flex flex-column">
                ...
                margin-top: 1px;">
                    <div class="about-info1">
                       <p class="prag4" style="padding-left: 20px; font-size: 25px">
                        You are loging to site success since 2 days
                    </div>
                </div>
